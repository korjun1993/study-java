...
public class StreamEx7 {
	public static void main(String[] args) {
		...
		Map<Boolean, Optional<Student2>> topScoreBySex = Stream.of(stuArr)
			.collect(
				Collectors.partitioningBy(Student2::isMale, Collectors.maxBy(Comparator.comparing(Student2::getScore))));
		...
		Map<Boolean, Student2> topScoreBySex2 = Stream.of(stuArr)
			.collect(
				Collectors.partitioningBy(Student2::isMale, Collectors.collectingAndThen(Collectors.maxBy(Comparator.comparing(Student2::getScore)), Optional::get)));
